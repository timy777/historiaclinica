...
describe('PersonalMedico Management Component', () => {
  let comp: PersonalMedicoComponent;
  let fixture: ComponentFixture<PersonalMedicoComponent>;
  let service: PersonalMedicoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'personal-medico', component: PersonalMedicoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PersonalMedicoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personalMedicos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
