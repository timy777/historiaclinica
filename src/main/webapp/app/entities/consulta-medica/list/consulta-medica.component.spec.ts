...
describe('ConsultaMedica Management Component', () => {
  let comp: ConsultaMedicaComponent;
  let fixture: ComponentFixture<ConsultaMedicaComponent>;
  let service: ConsultaMedicaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'consulta-medica', component: ConsultaMedicaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ConsultaMedicaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.consultaMedicas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
