...
export class ConsultaMedicaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.consultaMedicaService
      ...
      .subscribe({
        next: (res: HttpResponse<IConsultaMedica[]>) => {
  ...
  trackId(_index: number, item: IConsultaMedica): number {
    return item.id!;
  }

  delete(consultaMedica: IConsultaMedica): void {
    const modalRef = this.modalService.open(ConsultaMedicaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.consultaMedica = consultaMedica;
  ...
  protected onSuccess(data: IConsultaMedica[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
