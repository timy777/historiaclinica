...
export class TratamientoComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tratamientoService
      ...
      .subscribe({
        next: (res: HttpResponse<ITratamiento[]>) => {
  ...
  trackId(_index: number, item: ITratamiento): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITratamiento[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
