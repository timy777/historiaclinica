...
describe('CitaMedica Management Component', () => {
  let comp: CitaMedicaComponent;
  let fixture: ComponentFixture<CitaMedicaComponent>;
  let service: CitaMedicaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cita-medica', component: CitaMedicaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CitaMedicaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.citaMedicas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
