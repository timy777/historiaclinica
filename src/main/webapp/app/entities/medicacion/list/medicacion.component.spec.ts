...
describe('Medicacion Management Component', () => {
  let comp: MedicacionComponent;
  let fixture: ComponentFixture<MedicacionComponent>;
  let service: MedicacionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'medicacion', component: MedicacionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(MedicacionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.medicacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
