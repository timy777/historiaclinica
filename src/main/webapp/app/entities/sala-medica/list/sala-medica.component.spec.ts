...
describe('SalaMedica Management Component', () => {
  let comp: SalaMedicaComponent;
  let fixture: ComponentFixture<SalaMedicaComponent>;
  let service: SalaMedicaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sala-medica', component: SalaMedicaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SalaMedicaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.salaMedicas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
