...
import com.historiac.service.PacienteService;
...
/**
 * REST controller for managing {@link com.historiac.domain.Paciente}.
 */
@RestController
@RequestMapping("/api")
public class PacienteResource {
    ...
    public ResponseEntity<PacienteDTO> updatePaciente(
        ...
        PacienteDTO result = pacienteService.update(pacienteDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<PacienteDTO>> getAllPacientes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
